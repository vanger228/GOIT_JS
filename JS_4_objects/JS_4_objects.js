...
// -----Методи об'єкта
// Методами об'єкта називють функцію, яка знаходиться в об'єкті, тобто вона є значенням властивості об'єкта.
// const obj = {
//   method(value) {
...
// spread перетворює масив на список аргументів
...
// Створіть функцію filterEvenNumbers, яка приймає масив чисел і використовує цикл forEach, щоб створити новий масив, що містить лише парні числа з вихідного масиву. Поверніть отриманий масив парних чисел.
